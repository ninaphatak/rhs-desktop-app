import sys
import serial  # serial communication with ardurino
...
from PyQt5 import QtWidgets, QtCore, QtGui #GUI framwork for the window plotting
...
class RHSData(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # setup PyQtGraph layout which inludes the plotting and how big it is 
